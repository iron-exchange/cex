...
type GetUserInfoReq struct {
	g.Meta `path:"/user/info" tags:"User" method:"get" summary:"获取用户信息"`
	UserId uint64 `json:"userId"`
}

// GetUserAddressReq 获取用户地址请求
type GetUserAddressReq struct {
	g.Meta `path:"/user/address" tags:"User" method:"get" summary:"获取用户充币地址"`
}

// GetUserAddressRes 获取用户地址返回
