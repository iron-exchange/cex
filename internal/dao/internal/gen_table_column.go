...
// GenTableColumnColumns defines and stores column names for the table gen_table_column.
...
// genTableColumnColumns holds the columns for the table gen_table_column.
